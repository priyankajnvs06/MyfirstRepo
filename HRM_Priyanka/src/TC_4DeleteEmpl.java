...
{  
    ...
    /// to delete a emp from table
    dri.switchTo().frame("rightMenu");
    WebElement del= dri.findElement(By.xpath("//div[@class='actionbuttons']/input[2]"));
    del.click();
    Alert a=wait.until(ExpectedConditions.alertIsPresent());
    if(a.getText().equals("Select at least one record to delete"))
    	{
    		System.out.println("alert is present");
    		a.accept();
    	}
    dri.findElement(By.xpath("//table[@class='data-table']/tbody/tr[6]/td/input[@name='chkLocID[]']")).click();
    //dri.findElement(By.xpath("//table/tbody/tr/descendant::td[contains(text(),'10009')]/preceding-sibling::td/input")).click();
    del.click();
    Thread.sleep(2000);
